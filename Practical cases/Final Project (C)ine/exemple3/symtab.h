...
typedef struct t_info_TS{
    int tipus;          // tipus
    long int despla;    // desplaçament a memòria
    int mida;           // tipus ARRAY != 0, tipus bàsics = 0
} info_TS;


typedef info_TS sym_value_type;     // les entrades a la TS contenen 2 o 3 informacions (ARRAY)
